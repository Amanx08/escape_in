...
export default function DestinationsSection({ destinations }: { destinations: DestinationRecord[] }) {
  const heading = "Explore India destinations";
  ...
  return (
    <section className="py-20 bg-white">
      <div className="fw-container-custom d-flex align-items-center">
        ...
        >
          <Link href={ctaHref} className="bg-[#3a6a4c] hover:bg-[#2c5339] text-white px-6 py-2.5 rounded-full text-sm font-semibold tracking-wide flex items-center gap-2 transition-colors">
            {ctaLabel}
            <ArrowRight size={16} />
          </Link>
        </motion.div>
